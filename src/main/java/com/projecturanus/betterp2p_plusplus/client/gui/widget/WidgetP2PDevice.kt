package com.projecturanus.betterp2p_plusplus.client.gui.widget

import appeng.util.Platform
import com.projecturanus.betterp2p_plusplus.client.gui.InfoWrapper
...
class WidgetP2PDevice(private val selectedInfoProperty: KMutableProperty0<InfoWrapper?>, val modeSupplier: () -> BetterMemoryCardModes, var infoSupplier: () -> InfoWrapper?, var x: Int, var y: Int): Widget() {
    ...
    public val displayName = infoSupplier()?.displayName.toString()
    ...
    fun render(gui: GuiScreen, mouseX: Int, mouseY: Int, partialTicks: Float) {
        ...
        if (info != null) {
            ...
            fontRenderer.drawString(info.displayName, x + 24, y + 3, 0)
            fontRenderer.drawString(info.description, x + 24, y + 12, 0)
