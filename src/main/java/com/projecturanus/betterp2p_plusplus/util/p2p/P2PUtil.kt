...
import com.projecturanus.betterp2p_plusplus.network.P2PInfo
...
fun PartP2PTunnel<*>.getInfo(index: Int)
    = P2PInfo(index, frequency, location.pos, side.facing, isOutput, hasChannel, if (hasCustomInventoryName()) getCustomInventoryName() else "")
